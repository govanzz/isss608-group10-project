...
The full interpretation is presented in the [Findings](findings.qmd) page, where results from all analytical modules are consolidated into a single narrative.
